//
//  PVDetailMenuPopoverSettingController.m
//  PickViewMac
//
...
@interface PVDetailMenuPopoverSettingController ()

@property(nonatomic, strong) PVDetailPreferenceManager *manager;
...
@property(nonatomic, strong) PVDetailLabel *spaceSliderLabel;

@property(nonatomic, strong) NSButton *preferenceButton;

@end

@implementation PVDetailMenuPopoverSettingController

- (instancetype)initWithPreferenceManager:(PVDetailPreferenceManager *)manager {
    if (self = [self initWithContainerView:nil]) {
        ...
        self.spaceSlider.minValue = PVPreviewMinZInterspace;
        self.spaceSlider.maxValue = PVPreviewMaxZInterspace;
        self.spaceSlider.target = self;
        self.spaceSlider.action = @selector(_handleSpaceSlider:);
        [self.view addSubview:self.spaceSlider];
        
        self.spaceSliderLabel = [PVDetailLabel new];

...
#import "PVDetailTutorialPopoverController.h"
...
@interface PVDetailTutorialManager () <NSPopoverDelegate>

@end

@implementation PVDetailTutorialManager

+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static PVDetailTutorialManager *instance = nil;
...
- (void)showPopoverOfView:(NSView *)view text:(NSString *)text learned:(void (^)(void))learnedBlock {
    ...
    PVDetailTutorialPopoverController *vc = [[PVDetailTutorialPopoverController alloc] initWithText:text popover:popover];
...
- (void)popoverDidClose:(NSNotification *)notification {
    ...
    if (![vc isKindOfClass:[PVDetailTutorialPopoverController class]]) {
        NSAssert(NO, @"");
        return;
    }
    PVDetailTutorialPopoverController *tutorialVC = (PVDetailTutorialPopoverController *)vc;

//
//  PVDetailTutorialPopoverController.m
//  PickViewMac
//
...
@interface PVDetailTutorialPopoverController ()

@property(nonatomic, strong) NSImageView *imageView;
@property(nonatomic, strong) PVDetailLabel *label;
...
@implementation PVDetailTutorialPopoverController {

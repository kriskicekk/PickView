...
@interface PVDetailTextFieldView ()
...
@implementation PVDetailTextFieldView
...
+ (instancetype)labelView {
    PVDetailTextFieldView *view = [PVDetailTextFieldView new];
...
- (void)setTextColors:(PVDetailTwoColors *)textColors {

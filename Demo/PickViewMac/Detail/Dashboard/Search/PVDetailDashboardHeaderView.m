...
@interface PVDetailDashboardHeaderView () <NSTextFieldDelegate>
...
@implementation PVDetailDashboardHeaderView {
...
- (void)updateColors {
    [super updateColors];
    if (self.isActive) {
        self.inputBorderView.layer.borderColor = self.isDarkMode ? PVColorMake(70, 71, 72).CGColor : PVColorMake(198, 199, 200).CGColor;
    } else {
        self.inputBorderView.layer.borderColor = self.isDarkMode ? PVColorMake(47, 48, 49).CGColor : PVColorMake(220, 221, 222).CGColor;
    }
}

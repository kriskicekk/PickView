//
//  PVDetailDashboardAttributeSizeView.m
//  PickViewMac
//
...
@interface PVDetailDashboardAttributeSizeView () <NSTextFieldDelegate>

@property(nonatomic, copy) NSArray<PVDetailNumberInputView *> *inputsView;

@end

@implementation PVDetailDashboardAttributeSizeView
...
- (void)renderWithAttribute {
    ...
    NSArray<NSString *> *mainStrs = @[[NSString pv_inspect_stringFromDouble:size.width decimal:3],
                                      [NSString pv_inspect_stringFromDouble:size.height decimal:3]];

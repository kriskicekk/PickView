...
@interface PVDetailPanelContentView ()

@property(nonatomic, strong) NSImageView *titleImageView;
@property(nonatomic, strong) PVDetailLabel *titleLabel;
@property(nonatomic, strong) PVDetailBaseView *titleContainerView;

@property(nonatomic, strong) NSButton *cancelButton;

@end

@implementation PVDetailPanelContentView

- (instancetype)initWithFrame:(NSRect)frameRect {
    if (self = [super initWithFrame:frameRect]) {
        self.backgroundColorName = @"DashboardBackgroundColor";
        
        self.titleContainerView = [PVDetailBaseView new];
        ...
        _contentView = [PVDetailBaseView new];

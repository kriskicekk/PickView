...
@class PVDisplayItem, PVDetailHierarchyDataSource;

@interface PVDetailHierarchyRowView : PVDetailOutlineRowView
...
@property(nonatomic, weak) PVDisplayItem *displayItem;

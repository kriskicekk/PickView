...
#define PVDetailColorsCombine(colorA, colorB) [PVDetailTwoColors colorsWithColorInLightMode:colorA colorInDarkMode:colorB]

@interface PVDetailTwoColors : NSObject

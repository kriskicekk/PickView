...
@interface PVDetailBaseControl ()

@end

@implementation PVDetailBaseControl
...
- (void)setDidChangeAppearance:(void (^)(PVDetailBaseControl *, BOOL))didChangeAppearance {

//
//  PVDetailInputSearchSuggestionWindowController.m
//  PickViewMac
//
...
@implementation PVDetailInputSearchSuggestionWindowController

- (instancetype)init {
    PVDetailInputSearchSuggestionsContentView *view = [PVDetailInputSearchSuggestionsContentView new];

//
//  PVDetailStaticAsyncUpdateManager.h
//  PickViewMac
//
...
@class PVDisplayItem, PVDisplayItem;

@protocol PVDetailStaticAsyncUpdateManagerDelegate <NSObject>
...
@interface PVDetailStaticAsyncUpdateManager : NSObject

+ (instancetype)sharedInstance;

@property(nonatomic, weak) id<PVDetailStaticAsyncUpdateManagerDelegate> delegate;

...
@implementation PVEventHandler

#pragma mark - <NSCopying>

- (id)copyWithZone:(NSZone *)zone {
    PVEventHandler *newHandler = [[PVEventHandler allocWithZone:zone] init];
    newHandler.handlerType = self.handlerType;
    newHandler.eventName = self.eventName;
    newHandler.targetActions = [self.targetActions pv_inspect_map:^id(NSUInteger idx, PVStringTwoTuple *value) {
        return value.copy;
    }];

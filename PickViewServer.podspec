Pod::Spec.new do |s|
  ...
  s.ios.source_files = [
    'Source/PickViewServerKit/Internal/Inspection/iOS/*.{h,m}',
    'Source/PickViewServerKit/Internal/Inspection/iOS/Flutter/**/*.{h,m}'
  ]
  ...
  s.ios.private_header_files = [
    'Source/PickViewServerKit/Internal/Inspection/iOS/*.h',
    'Source/PickViewServerKit/Internal/Inspection/iOS/Flutter/**/*.h'
  ]

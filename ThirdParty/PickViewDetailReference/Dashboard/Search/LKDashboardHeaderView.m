...
- (void)updateColors {
    [super updateColors];
    if (self.isActive) {
        self.inputBorderView.layer.borderColor = self.isDarkMode ? PickViewColorMake(70, 71, 72).CGColor : PickViewColorMake(198, 199, 200).CGColor;
    } else {
        self.inputBorderView.layer.borderColor = self.isDarkMode ? PickViewColorMake(47, 48, 49).CGColor : PickViewColorMake(220, 221, 222).CGColor;
    }
}

...
//        self.layer.borderColor = [NSColor redColor].CGColor;
        ...
        self.inputViews = [NSArray pickview_arrayWithCount:4 block:^id(NSUInteger idx) {
...
- (void)renderWithAttribute {
    ...
    NSArray<NSString *> *strs = @[[NSString pickview_stringFromDouble:opacity decimal:2],
                                  [NSString pickview_stringFromDouble:radius decimal:2],
                                  [NSString pickview_stringFromDouble:offset.width decimal:2],
                                  [NSString pickview_stringFromDouble:offset.height decimal:2]];

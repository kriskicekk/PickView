...
- (void)renderWithAttribute {
    ...
    NSArray<NSString *> *mainStrs = @[[NSString pickview_stringFromDouble:rect.origin.x decimal:3],
                                  [NSString pickview_stringFromDouble:rect.origin.y decimal:3],
                                  [NSString pickview_stringFromDouble:rect.size.width decimal:3],
                                  [NSString pickview_stringFromDouble:rect.size.height decimal:3]];

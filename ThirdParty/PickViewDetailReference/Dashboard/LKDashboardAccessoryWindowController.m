...
@property(nonatomic, strong) NSMutableDictionary<PVAttrSectionIdentifier, LKDashboardSectionView *> *sectionViews;
...
- (NSSize)renderWithAttrSections:(NSArray<PVAttributesSection *> *)sections {
    ...
    __block CGFloat y = 8;
    [[PickViewDashboardBlueprint sectionIDsForGroupID:self.groupID] enumerateObjectsUsingBlock:^(PVAttrSectionIdentifier _Nonnull secID, NSUInteger idx, BOOL * _Nonnull stop) {

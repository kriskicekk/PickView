//
//  PickViewDisplayItem+PickViewClient.h
//  PickView
//
...
@interface PickViewDisplayItem (PickViewClient)
...
/// 遍历自身和所有上级元素
- (void)enumerateSelfAndAncestors:(void (^)(PickViewDisplayItem *item, BOOL *stop))block;

- (void)enumerateAncestors:(void (^)(PickViewDisplayItem *item, BOOL *stop))block;

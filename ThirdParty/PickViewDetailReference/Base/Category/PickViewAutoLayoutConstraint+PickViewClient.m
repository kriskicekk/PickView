//
//  PickViewAutoLayoutConstraint+PickViewClient.m
//  PickView
//
...
@implementation PickViewAutoLayoutConstraint (PickViewAutoLayoutConstraint)


+ (NSString *)descriptionWithItemObject:(PickViewObject *)object type:(PickViewConstraintItemType)type detailed:(BOOL)detailed {
    switch (type) {
        case PickViewConstraintItemTypeNil:
            return detailed ? @"Nil" : @"nil";
            
        case PickViewConstraintItemTypeSelf:
            return detailed ? @"Self" : @"self";
            
        case PickViewConstraintItemTypeSuper:
            return detailed ? @"Superview" : @"super";
            
        case PickViewConstraintItemTypeView:
        case PickViewConstraintItemTypeLayoutGuide:

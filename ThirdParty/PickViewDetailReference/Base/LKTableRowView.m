...
- (instancetype)initWithFrame:(NSRect)frameRect {
    if (self = [super initWithFrame:frameRect]) {
        ...
        [self.backgroundColorLayer pickview_removeImplicitAnimations];
...
- (void)_updateBackgroundLayerColor {
    if (self.isSelected) {
        ...
        self.backgroundColorLayer.backgroundColor = self.isDarkMode ? PickViewColorRGBAMake(255, 255, 255, .15).CGColor : PickViewColorRGBAMake(0, 0, 0, .1).CGColor;
    } else {

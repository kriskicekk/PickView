...
@class PickViewHierarchyInfo, PickViewDisplayItem, PickViewStaticDisplayItem, LKPreferenceManager;
...
@property(nonatomic, copy, readonly) NSArray<PickViewDisplayItem *> *flatItems;
